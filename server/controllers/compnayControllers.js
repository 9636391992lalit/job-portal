...
export const loginCompany = async (req, res) => {
    ...
    try {
        ...
        if (!company) {
            res.json({ success: false, message: "Company does not exit You want to create Account" })
        }
...
export const getCompanyJobApplicants = async (req, res) => {
    try{
const companyId=req.company._id// Find job application for the user and  populate related data
