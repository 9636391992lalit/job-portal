          ...
          <tbody>
            {viewApplicationsPageData.map((applicant,index)=>
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b max-sm:hidden'>{applicant.jobTittle}</td>
                <td className='py-2 px-4 border-b max-sm:hidden'>{applicant.location}</td>
                <td className='py-2 px-4 border-b'>
                  <a href="" target="blank" className='=bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center'>
