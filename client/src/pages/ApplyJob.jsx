        ...
        <div className='flex justify-center md:justify-between flex-wrap gp-8 px-14 py-20 mb-6 bg-sky-50 border-sky-400 rounded-xl'>
          <div className='flex flex-col md:flex-row items-center'>
            ...
            <div className='text-center md:text-left text-neutral-700'>
              ...
              <div className='flex flex-row flex-wrqp max-md:justify-center gap-y-2  gap-6 items-center text-gray-600 mt-2'>
          ...
          <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
            ...
            {isAlreadyApplied?'Already Applied Applied':'Apply now'}
            </button>
            <p className='mt-1 text-gray-600'>Posted {moment(JobData.date).fromNow()}</p>
          </div>
        </div>
        <div className="flex flex-clo lg:flex-row justify-between items-start">
          <div className='w-full lg:w-2/3'>
            <h2 className='font-bold text-2xl mb-4'>Job Description</h2>
            <div  className="rich-text" dangerouslySetInnerHTML={{__html:JobData.description}}></div>
            <button onClick={applyHandler} className="bg-blue-600 p-2.5 px-10 text-white rounded mt-10">{isAlreadyApplied?'Already Applied Applied':'Apply now'}</button>
          </div>
          <div className='w-full lg:w-1/3 mt-8 lg:mt-8 space -y-5'> 
