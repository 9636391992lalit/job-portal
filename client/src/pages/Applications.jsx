...
const Applications = () => {
  ...
  try{
      ...
      console.log("Update resume token",   token)
    ...
    <>
       ...
       <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
        ...
        <table  className ='min-w-full bg-white border rounded-lg'>
          ...
          <tbody>
             {userApplications.map((job,index)=>job?(<tr key={job._id || index}>
              <td className='py-3 px4 items-center gap-2 border-b'>
                <img className='w-7 h-8'src={job.companyId.image} alt="" />
                {job.companyId.name}
              </td>
